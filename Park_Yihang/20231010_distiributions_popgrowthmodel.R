...
#do 100 iteration of 1 coin flip with equal probability of getting 0 or 1
b=rbinom(100, 1, prob=c(0.5, 0.5))
b
sum(b)/length(b)


rbinom(1, 100, prob=c(0.5, .05))
...
#now, use sapply to calculate N across tome (t) at differet growth rates (lambda)
...
#### Now create the stochastic model
lambda=rnorm(times=1, meanlog=0, sdlog=0.1)
for(t in 2:times){
