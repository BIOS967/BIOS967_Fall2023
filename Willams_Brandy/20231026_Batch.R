...
list.files("data")
#list all files in "data" folder that contain ".csv"
list.files("data",pattern=".csv")

#press"tab" after typing "data/" and it will pull up a list of data folders
...
#you can batch import multiple datasets using lapply and a set of pathnames to the data
...
#combine the 6 datasets in the list into 1 dataset
...
bind_rows(dats.R1A35, dats.R2A35)
...
bind_rows(dats.R1A35, dats.R2A35, dats.R3A35)
...
#we can calculate the distance that a bird traveled in a trial by summing thr "distance" variable
